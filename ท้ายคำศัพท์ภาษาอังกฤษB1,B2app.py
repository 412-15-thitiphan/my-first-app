...
st.title("🎮 เกมท้ายคำศัพท์ภาษาอังกฤษB1,B2")
...
ans1 = st.text_input(
    "ข้อ 1: `_ _ _ _ _ _ _ _` (ทัศนคติ)",
    value=st.session_state.ans1_val,
)
ans2 = st.text_input(
    "ข้อ 2: `_ _ _ _ _ _ _ _ _ _ _` (รู้สึกอาย)",
    value=st.session_state.ans2_val,
)
ans3 = st.text_input(
    "ข้อ 3: `_ _ _ _ _ _ _ _ _ _` (ห้องแล็บ)",
